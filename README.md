...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/overrides-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3177&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/overrides-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `overrides` can be installed with:

```
conda install overrides
```

It is possible to list all of the versions of `overrides` available on your platform with:
